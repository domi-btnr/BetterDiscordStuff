            ...
            observer(changes) {
              ...
              if (inBDSettings) {
                ...
                if (inPluginSettings && !titlePatched) {
                  ...
                  BDSettingsHeader.innerHTML =
                    `PLUGINS - ${enabledPlugins}/${plugins.length + 1}` +
                    BDSettingsHeader.innerHTML.slice(
                      BDSettingsHeader.innerHTML.search("<button")
                    );
                  ...
                  BDSettingsHeader.innerHTML =
                    `THEMES - ${enabledThemes}/${themes.length + 1}` +
                    BDSettingsHeader.innerHTML.slice(
                      BDSettingsHeader.innerHTML.search("<button")
                    );
