...
const config = {
  ...
  changelog: [
    ...
    },
    {
      title: "Improved",
      type: "improved",
      items: ["Channelmentions lead to the channel"],
    }
  ],
  defaultConfig: [
    {
    ...
    class NitroSniper extends Plugin {
      ...
      onStart() {
        ...
        this.unpatchDispatch = BdApi.monkeyPatch(
          BdApi.findModuleByProps("dispatch", "dirtyDispatch"),
          "dispatch",
            ...
            if (this.settings.notifications != 2) {
              if (this.settings.toast)
                ...
                BdApi.alert("Nitro code redeemed | NitroSniper", [
                  ...
                  ChannelRow,
                  UserRow,
                  `Message Link: https://discord.com/channels/${message.guild_id || "@me"
            ...
            if (this.settings.webhook) {
              ...
              const data = {
                ...
                embeds: [
                  {
                    title: `${guild}, #${channel}`,
                    url: `https://discord.com/channels/${message.guild_id || "@me"
                      }/${message.channel_id}/${message.id}`,
