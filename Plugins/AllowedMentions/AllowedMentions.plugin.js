    ...
    changelog: [
        {
            title: "FIXED",
            type: "fixed",
            items: ["The button will now rerender when you switch channel", "The button will now disappear when your in a channel and dont have permission send messages"],
        }
    ],
};
...
module.exports = !global.ZeresPluginLibrary
    ...
    : (([Plugin, Library]) => {
        ...
        const canSendMessagesInChannel = function (channel) {
            ...
            try {
                return Permissions.can(DiscordConstants.Permissions.SEND_MESSAGES, UserStore.getCurrentUser(), channel);
            } catch (error) {
                return true;
            }
        };
