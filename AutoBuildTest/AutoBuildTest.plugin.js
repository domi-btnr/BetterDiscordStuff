 ...
 * @name AutoBuildTest
 * @version 0.0.3
 * @description Just a Test for AutoBuild
 * @author HypedDomi
 * @source https://github.com/HypedDomi/BetterDiscordStuff/AutoBuildTest
 * @updateUrl https://raw.githubusercontent.com/HypedDomi/BetterDiscordStuff/main/AutoBuildTest/AutoBuildTest.plugin.js
 */
/*@cc_on
@if (@_jscript)
...
const config = {
	"info": {
		...
		"github": "https://github.com/HypedDomi/BetterDiscordStuff/AutoBuildTest",
		"github_raw": "https://raw.githubusercontent.com/HypedDomi/BetterDiscordStuff/main/AutoBuildTest/AutoBuildTest.plugin.js"
	},
	"changelog": [{
		"type": "added",
		"title": "AutoBuildTest",
...
function buildPlugin([BasePlugin, PluginApi]) {
	...
	(() => {
		...
		__webpack_require__.d(__webpack_exports__, {
			default: () => AutoBuildTest
		});
		const external_BasePlugin_namespaceObject = BasePlugin;
		var external_BasePlugin_default = __webpack_require__.n(external_BasePlugin_namespaceObject);
		class AutoBuildTest extends(external_BasePlugin_default()) {
			onStart() {}
			onStop() {}
		}
