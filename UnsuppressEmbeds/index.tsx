...
export default class UnsuppressEmbeds {
    ...
    patchMessageContextMenu() {
        ...
        unpatchContextMenu = ContextMenu.patch(
            "message",
            (res, { channel, message: { author, messageSnapshots, embeds, flags, id: messageId } }) => {
                const isEmbedSuppressed = (flags & EMBED_SUPPRESSED) !== 0;
                const hasEmbedsInSnapshots = messageSnapshots.some((snapshot: any) => snapshot?.message.embeds.length);
