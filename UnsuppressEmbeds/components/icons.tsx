...
export function ImageVisible(props: IconProps) {
    return (
        <svg {...props} className={Utils.className(props.className, "image-visible")} viewBox="0 0 24 24">
            <path
                fill="currentColor"
...
export function ImageInvisible(props: IconProps) {
    return (
        <svg {...props} className={Utils.className(props.className, "image-invisible")} viewBox="0 0 24 24">
            <path
                fill="currentColor"
